...
//                 row.innerHTML = `
//                     <td classs="row_text">${metaData["2. Symbol"]}</td>
//                     <td class="row_text">$${time[timeStamp]["2. high"]}</td>
//                     <td classs="row_text">${totalChange}</td>
//                     <td classs="row_text">${time[timeStamp]["5. volume"]}</td>
//                 `
//             }else{
//                 stock.innerHTML = `
//                     <p>Stock data not available for ${STOCK_SYMBOL}.</p>
//                 `
